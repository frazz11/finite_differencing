...
class Derivatives:
    ...
    class Derivative:
        ...
        def calculate_derivative(self,
            ...
            for i, s in enumerate(stencil.stencil):
                self.derivative[self.is_:self.ie_] = \
                        self.derivative[self.is_:self.ie_]\
                        + s * array[self.is_ + i-S_2:self.ie_ + i-S_2]
    ...
    def __str__(self):
        return f"Derivative of order {self.order}\
                and order of accuracy {self.accuracy_order}."
